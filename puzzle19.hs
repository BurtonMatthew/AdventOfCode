...
solvePart1 initRegisters (Program boundRegister instructions) = solvePart1' 0 initRegisters where
    ...
    solvePart1' ip registers 
        | ip < 0 || ip > maxInstruction = r0 registers
...
Reverse Engineered the ASM for part 2

part1 = sumOfFactors(1010)
part2 = sumOfFactors(10551410)

int sumOfFactors(int goal)
{
    sumFactors = 0
    r3 = 1
    while(r3 <= r1)
